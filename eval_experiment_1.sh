...
python tools/map_res_extract_v2.py --path /home/data/agile3d/carl/waymo_dpo_contention_slo500_accumulate16_range_5_10_e9_cl00.txt

python tools/map_res_extract_v2.py --path /home/data/agile3d/carl/waymo_dpo_contention_slo500_accumulate16_range_5_10_e9_cl20.txt

python tools/map_res_extract_v2.py --path /home/data/agile3d/carl/waymo_dpo_contention_slo500_accumulate16_range_5_10_e9_cl50.txt

python tools/map_res_extract_v2.py --path /home/data/agile3d/carl/waymo_dpo_contention_slo500_accumulate16_range_5_10_e9_cl90.txt
